...
public enum TypeMessage {
    ...
    EVENT_TORCH(true, "Agora você consegue entrar no porão do templo!", ""),
    EQUIP_EVENT_TORCH(true, "Tocha equipada e agora você consegue entrar no porão do templo!", "tocha"),
