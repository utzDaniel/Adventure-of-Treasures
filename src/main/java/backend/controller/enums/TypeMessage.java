...
public enum TypeMessage {
    ...
    EQUIP_ERROR(false, "Item ja está equipado!", "erro"),
    UNEQUIP(true, "Item foi desequipado", ""),
    UNEQUIP_SCHOOLBAG(true, "Mochila desequipada", "mochila"),
    UNEQUIP_ERROR_SCHOOLBAG(false, "Remove itens da mochila, antes de tentar desequipar", "erro"),
    ...
    UNEQUIP_ERROR(false, "Item ja está desequipado!", "erro"),
    ...
    MAP_ERROR_FOUND(true, "Map não encontrado", ""),
    ...
    INVENTORY_ITEM_ERROR_FOUND(false, "Item não encontrado no inventário!", "erro"),
    ...
    ITEMS_ERROR_SIZE(false, "Deve conter apenas um item!", "");
