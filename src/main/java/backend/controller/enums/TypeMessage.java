...
public enum TypeMessage {
    ...
    COMBINE_TORCH(true, "Item combinados, novo item tocha!", "fogo"),
    COMBINE_MAP(true, "Item combinados, novo item mapa!", "mapa"),
    COMBINE_LADDER(true, "Item combinados, novo item escada!", "construir"),
